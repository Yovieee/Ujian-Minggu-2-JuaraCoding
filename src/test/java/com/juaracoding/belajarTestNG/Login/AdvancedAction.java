package com.juaracoding.belajarTestNG.Login;
...
public class AdvancedAction {
    ...
    public void sigInTest() {
        ...
        Action action = actions
                .sendKeys(usernameFieldElem, "admin").pause(Duration.ofSeconds(1))
                .sendKeys(passwordFieldElem, "P@ssw0rd24qwe").pause(Duration.ofSeconds(1))
...
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(1));
    ...
    public void osloTest() throws InterruptedException {
        ...
        jse.executeScript("window.scrollBy({top: 650, behavior: 'smooth'})");
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(4));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(15));
        WebElement draggable = wait.until(ExpectedConditions.elementToBeClickable(By.id("box1")));
